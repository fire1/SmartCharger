...
function(GENERATE_CPP_FROM_SKETCH MAIN_SKETCH_PATH SKETCH_SOURCES SKETCH_CPP)
    ...
    #arduino_debug_msg("SKETCH_HEAD:\pinStateEncoder${SKETCH_HEAD}")
    ...
    #arduino_debug_msg("BODY:\pinStateEncoder${SKETCH_BODY}")
    ...
    #file(APPEND ${SKETCH_CPP} "\pinStateEncoder#line 1 \"autogenerated\"\pinStateEncoder")
...
function(REMOVE_COMMENTS SRC_VAR OUT_VAR)
    ...
    #message(STATUS "\pinStateEncoder${SRC}")
